...
<body style="background: #f8f4ed">
	...
	<br>
	<br>
	<center><p class="head1">Please fill out the form or drop a mail at </p><div class="blink"><span>[</span></div> <p class="head1">mohitsshetty986@gmail.com</p> <div class="blink"><span>]</span></div><p class="head1"> and I will reach out to you soon!</p></center>
	<br><br>
	<div id="container1">
	<br>
