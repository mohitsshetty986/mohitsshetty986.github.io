			...
			<input type="text" id="myInput" onkeyup="myFunction1()" placeholder="Search feed.." title="Type in a name">
				...
				<ul id="myUL">
					...
					<li><a href="javascript:void(0);"><p class="large-text">The Boring Company</p>
						<img src="facts/theboringcompany.jpg" id="myImg1" class="factimg" alt="Loop Test tunnel in Hawthorne, California">
					...
					<li><a href="javascript:void(0);"><p class="large-text">Blockchain</p>
						<img src="https://github.com/mohitsshetty986/secondary/blob/main/blockchain.JPG?raw=true" id="myImg" class="factimg" alt="">
