		...
		<div class="container">
			<input type="text" id="myInput" onkeyup="myFunction1()" oninput="myFunction2()" placeholder="Search feed.." title="Type in a name">
				...
				<ul id="myUL">
				  ...
				  <li><a href=""><p class="large-text" id="spot"></p>
						<img src="facts/spot.jpg" id="myImg1" class="factimg" alt="">
						<p class="small-text">      <span class="dots">...</span><span class="more"> </span> <button class="read">read more</button></p></a></li>
				  <li><a href=""></a></li>
