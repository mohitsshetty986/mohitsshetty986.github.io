				...
				<ul id="myUL">
					...
					<li><a href="#blockchain"><p class="large-text" id="blockchain">Blockchain</p>
				 	...
				 	<li><a href="#gigafactory"><p class="large-text" id="gigafactory">Tesla Gigafactory</p>
						...
						<p class="small-text"> Do you know what the most important thing Tesla makes ? Elon Musk calls it a Giant machine that builds a machine. A futuristic manufacturing facility primarily producing lithium-ion batteries - 13 million per day and electric motors for the Tesla Model 3, Tesla’s cheapest-ever car, plus the Powerwall and Powerpack energy storage systems designed to work with renewable sources. It's called the "GIGAFACTORY". <span class="dots">...</span><span class="more">Musk says the whole point of the building a gigafactory is to make batteries that can be used to store renewable energy like solar and are more affordable. Currently Tesla produces 60 percent of the Globe's EV batteries and is planning to ramp production to 500,000 cars per year which would require today's entire worldwide supply of lithium-ion batteries. With battery production more than all other carmakers combined in terms of kWh, Tesla is accelerating to achieve production of terawatt-hour battery (per year), the million mile battery for future cars which will hold more charge and have lower price point. Tesla's current cost to manufacture a battery cell is $116 per KWH which is far ahead of the industry- $146 per KWH. Tesla's project Road runner aims to reduce costs to $100 per KWH by 2021. There are 5 proposed Gigafactory projects around globe - Nevada, New York, Berlin, Shanghai and Texas. The size of each Gigafactory is massive with the Sparx Nevada based facility being the biggest. On completion it will be the biggest building in the world by footprint about 15 million square feet of land, and the second biggest by volume. It's large enough to house 107 NFL football fields or 93 Boeing 747s. Working alongside factories 7000 employees, are a team of automated robots that help move materials using digital maps between workstations faster and lift heavier loads staying charged for 19 hours. Gigafactory is being built with the end in mind of being a net-zero facility. There'll be over 200,000 solar panels on the roof, with the largest array of solar panels anywhere to provide most of the building’s energy, paired with Tesla’s batteries.  Building a massive facility which runs on 100% renewable energy source as the Gigafactory means increased production, decreased cost, reduction of waste, and the simple optimization of locating most manufacturing processes under one roof.</span> <button class="read">read more</button></p>
						</a></li>
