			...
			<input type="text" id="myInput" onkeyup="myFunction1()" placeholder="Search feed.." title="Type in a name">
				...
				<ul id="myUL">
				  <li><a href="#"><p class="large-text">Tesla Gigafactory</p>
						...
						<p class="small-text"> Do you know what the most important thing Tesla makes ? Elon Musk calls it a Giant machine that builds a machine. It's called GIGAFACTORY, Giga meaning a Billion. It primarily produces lithium-ion batteries - 13 million per day and electric motors for the Tesla Model 3, Tesla’s cheapest-ever car, plus the Powerwall and Powerpack energy storage systems designed to work with renewable sources. The size of the First Gigafactory facility is massive. On completion it will be the biggest building in the world by footprint about 5.8 million square feet, and the second biggest by volume. It's large enough to house 107 NFL football fields or 93 Boeing 747s. Tesla's plan is to ramp production to 500,000 cars per year and for that it would require today's entire worldwide supply of lithium-ion batteries. Currently Tesla produces 60 percent of the Globe's EV batteries and it's accelerating to achieve production of terawatt-hour battery (per year), the million mile battery for future cars which will hold more charge and have lower price point. Gigafactory is being built with the end in mind of being a net-zero facility. There'll be over 200,000 solar panels on the roof, with the largest array of solar panels anywhere to provide most of the building’s energy, paired with Tesla’s batteries. Musk says the whole point of the massive facility is to make batteries that can be used to store renewable energy like solar more affordable.</p>
