...
<body style="background: #f8f4ed">
			...
			<input type="text" id="myInput" onkeyup="myFunction1()" placeholder="Search feed.." title="Type in a name">
				...
				<ul id="myUL">
					...
					<li><a href="javascript:void(0);"><p class="large-text">Blockchain</p>
						<img src="https://github.com/mohitsshetty986/secondary/blob/main/blockchain.JPG?raw=true" id="myImg" class="factimg2" alt="">
	...
	<script>
		...
		// Get the image and insert it inside the modal - use its "alt" text as a caption
		var img1 = document.getElementsByClassName("factimg2");
