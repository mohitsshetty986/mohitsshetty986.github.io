			...
			<input type="text" id="myInput" onkeyup="myFunction1()" placeholder="Search feed.." title="Type in a name">
				...
				<ul id="myUL">
				 	<li><a href="#"><p class="large-text">Tesla Gigafactory</p>
						<img src="facts/gigafactory.jpg" id="myImg" alt="Gigafactory Nevada" class="factimg">
				  	...
				  	<li><a href="#"><p class="large-text">Voyagers</p>
						<img src="facts/goldernrecord.jpg" id="myImg" alt="Goldern Record" class="factimg1">
					...
					<li><a href="#"><p class="large-text">Hyperloop</p>
						<img src="facts/hyperloop.jpg" id="myImg" alt="Virgin Group Hyperloop" class="factimg">
